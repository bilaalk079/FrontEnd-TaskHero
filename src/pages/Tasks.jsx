...
const Tasks = () => {
  ...
  return (
    <div className="w-full ">
      ...
      <div className="flex">
        <button className="text-white font-bold flex text-2xl p-2 rounded-xl cursor-pointer m-3 bg-slate-800 hover:bg-slate-700" onClick={()=>setFilterModal(false)}>
          <span> Filters   </span><FaFilter  />
        </button>
        <span className="text-white text-2xl font-bold my-5 mx-2"> || </span>
        <h1 className="text-2xl my-3  p-2 font-bold text-white ">
          Sort:
        </h1>
         <select
  ...
  <div className="fixed inset-0 z-50 flex items-center justify-center backdrop-blur-sm bg-opacity-50">
    <div className="bg-slate-950 rounded-lg p-6 w-96 shadow-lg relative">
      ...
      <button className="p-2 text-lg font-bold text-white rounded-xl cursor-pointer bg-gradient-to-r from-indigo-700 via-purple-600 to-blue-600 hover:opacity-90 transition duration-300" 
      onClick={clearFilter}>
        Clear Filters
      </button>
    </div>
      ...
      )) : <h1 className="text-center text-4xl font-bold text-white m-10"> No Tasks Found, <a className="text-blue-600 hover:underline" href="/dashboard/create">Create a new Task</a> </h1>}
